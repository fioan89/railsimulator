 ...
 * 
 * <pre>
 * A1 _ _ _ _ _ _ _ _ _ _ _ _ _ S1 _ _ _ _ _ _ _ _ _ S3 _ _ _ _ _ _ _ _ B1
 * </pre>
 * 
 * <pre>
 * * * * * * * * * * * * * * * * \ * * * * * * * * * / * * * * * * * * * *
 ...
 * 
 * <pre>
 * A2 _ _ _ _ _ _ _ _ _ _ _ _ _ _ S2 _ _ _ _ _ _ _ S4 _ _ _ _ _ _ _ _ _ B2
 * </pre>
 * 
 * Here A1, A2, B1, B2 represents train stations. S1, S2, S3, S4 represents
 * track switches where rail vehicles can switch tracks. "*" is just a mark for
 * unused space. It should be ignored when the actual painting takes place.
 * 
 * @author faur
 * @since November 06 2012
 * 
 * @param <T>
 *            generic parameter. Usually is a <code>String</code> key.
 * @param <U>
