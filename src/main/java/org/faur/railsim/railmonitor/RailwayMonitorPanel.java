...
public class RailwayMonitorPanel extends JPanel {
    ...
    /**
     * Loads map and train coordinates, draws them on the graphic context
     * and enables the auto refreshing of the panel.
     */
	...
	if (mapLoader != null) {
		...
		public void run() {
			...
			try {
			    ...
			    logger.log(Level.SEVERE, "Painting thread interrupted: {0}", e);
			}
		    }
		}
	    }).start();
	    ...
	    JOptionPane.showMessageDialog(this, "Warning!",
		    ...
		    + " .\nPlease specify a new file path!", JOptionPane.WARNING_MESSAGE);
	}
    }

    /**
     * Removes all the trains from that needs to be
     * painted on the map.
     */
    ...
    /**
     * Adds a new train that should be painted on the railway map 
     * and the location where it will be painted.
     * 
     * @param train an instance of the rail vehicle.
     * @param location place on the rail map where the vehicle will be painted.
     */
