...
public interface ITrain {
   ...
   public void draw(Graphics g);
    ...
    /**
     * Sets train location. This is a 2D point and will be mostly used
     * when a representation of this vehicle will be used to paint it.
     * 
     * @param location a 2D point on the railway map.
     */
